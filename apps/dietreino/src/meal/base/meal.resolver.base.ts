...
import { MealPlanFindManyArgs } from "../../mealPlan/base/MealPlanFindManyArgs";
...
export class MealResolverBase {
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [MealPlan], { name: "mealPlans" })
  @nestAccessControl.UseRoles({
    resource: "MealPlan",
    action: "read",
    possession: "any",
  ...
  async findMealPlans(
    ...
    const results = await this.service.findMealPlans(parent.id, args);
