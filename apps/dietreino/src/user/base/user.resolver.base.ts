...
export class UserResolverBase {
  ...
  async createUser(@graphql.Args() args: CreateUserArgs): Promise<User> {
    return await this.service.createUser({
      ...
      data: {
        ...
        mealPlan: args.data.mealPlan
          ? {
              connect: args.data.mealPlan,
            }
          : undefined,
      },
    });
  ...
  async getMealPlan(@graphql.Parent() parent: User): Promise<MealPlan | null> {
    const result = await this.service.getMealPlan(parent.id);
